import bcryptjs from 'bcryptjs'; //Para ocultar la contraseña en la base de datos
...
//info de un usuario para hacer el seed
interface SeedUser {
    email:string;
    name:string;
    password:string;
...
interface SeedData {
    users:SeedUser[]; //un arreglo de Seed User, cada objeto[{}]
    categories:string[];
    ...
    users:[
        {
            ...
            name:'GonzaloH',
            password:bcryptjs.hashSync('123456'), //para encriptar la contraseña, clave
            role:'admin'
        },
        {
            email: 'sofia@google.com',
            name:'SofiaP',
            password:bcryptjs.hashSync('123456'), //para encriptar la contraseña, clave
            role:'user'
        },
